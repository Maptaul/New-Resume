  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "TypeScript", level: 80, syntax: "let typed: string = 'TS';" },
        { name: "React", level: 88, syntax: "<Component />" },
        { name: "Next.js", level: 80, syntax: "<NextPage />" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center space-x-2 mb-6">
            ...
            <h2
              className={`text-3xl sm:text-4xl font-bold font-mono transition-colors ${
          ...
          {skillCategories.map((category, categoryIndex) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`rounded-xl shadow-sm hover:shadow-md transition-all p-6 border-2 ${
                  colors.border
              ...
              >
                <div
                  className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-mono font-medium mb-6 ${colors.bg} ${colors.text}`}
                >
        ...
        >
          <h3
            className={`font-mono text-lg font-semibold mb-4 transition-colors ${
              isDarkMode ? "text-dev-text" : "text-gray-900"
            }`}
          >
            <span className="text-dev-comment">// </span>My development
            philosophy
          </h3>
          <pre className="font-mono text-sm overflow-x-auto">
            <code className={isDarkMode ? "text-dev-text" : "text-gray-700"}>
              ...
              <br />
              {"    "}
              <span className="text-dev-string">cleanCode</span>:{" "}
              <span className="text-dev-keyword">true</span>,
              <br />
              {"    "}
              <span className="text-dev-string">userFirst</span>:{" "}
              <span className="text-dev-keyword">true</span>,
              <br />
              {"    "}
              <span className="text-dev-string">performance</span>:{" "}
              <span className="text-dev-string">"optimized"</span>,
              <br />
              {"    "}
              <span className="text-dev-string">responsive</span>:{" "}
              <span className="text-dev-string">"always"</span>
              <br />
              {"  "}
              {"}"}
              <br />
